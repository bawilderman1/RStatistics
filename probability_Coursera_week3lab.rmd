...
<li> The shortest streak is of length 1. ***Answer***</li>
</ol>

## Compared to What?
```{r boxplot-kobe-streak}
boxplot(kobe_streak)
```
...
<ol>
<li> The distributions look very similar. Therefore, there doesn't appear to be evidence for Kobe Bryant's hot hand. ***answer***</li>
